...
import 'package:agility_app/Presentation/screen/services/delivery.dart';
...
class AddNewDelivery extends StatefulWidget {
  const AddNewDelivery({Key? key}) : super(key: key);
  static String routeName = "/addNewDelivery";

  @override
  _AddNewDeliveryState createState() => _AddNewDeliveryState();
}
