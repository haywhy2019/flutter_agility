...
import 'package:agility_app/Presentation/screen/services/eletricals.dart';
...
class AddNewElectrical extends StatefulWidget {
  const AddNewElectrical({Key? key}) : super(key: key);
  static String routeName = "/addElectrical";

  @override
  _AddNewElectricalState createState() => _AddNewElectricalState();
}

class _AddNewElectricalState extends State<AddNewElectrical> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      lazy: false,
      create: (context) => ElectricalBloc(ElectricalRepository()),
      child: Scaffold(
          appBar: AppBar(
          ...
          body: Padding(
              ...
              child: BlocConsumer<ElectricalBloc, ElectricalState>(
                listener: (context, state) {},
                builder: (context, state) {
                  if (state is ElectricalInitial) {
