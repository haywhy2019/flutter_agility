...
import 'package:agility_app/Presentation/screen/services/add_food.dart';
...
class _FoodScreenState extends State<FoodScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      lazy: false,
      create: (context) => FoodBloc(FoodRepository())..add(const FetchFood()),
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.black,
          title: const Text(
            "Food or Snack Vendor",
            ...
            BlocBuilder<FoodBloc, FoodState>(
              builder: (context, state) {
                ...
                if (state is FoodLoaded) {
                  ...
                  return const FoodHttpErrors();
                } else if (state is FoodNoData) {
                  return const NoDataWidget(
                      mesg: "No Food Vendor Registered yet");
                } else {
...
class FoodHttpErrors extends StatelessWidget {
  const FoodHttpErrors({
    Key? key,
  }) : super(key: key);
