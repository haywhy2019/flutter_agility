...
abstract class ServiceRepository {
  ...
  Future addShop(Users url);
}

class ShopRepository implements ServiceRepository {
  var url =
      Uri.parse('https://agility-87280-default-rtdb.firebaseio.com/shop.json');
  @override
  Future addShop(Users data) async {
    try {
