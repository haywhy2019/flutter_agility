...
abstract class ServiceRepository {
  ...
  Future addElectrical(Users url);
}

class ElectricalRepository implements ServiceRepository {
  var url = Uri.parse(
      'https://agility-87280-default-rtdb.firebaseio.com/electrical.json');
  @override
  Future addElectrical(Users data) async {
    try {
